...
public class InfoProcessorTest {
	...
	void testGetCourseName() {
		...
		String actual4 = infoProcessor4.getCourseName();
		assertEquals("CIT 593", actual4);

		String actual5 = infoProcessor5.getCourseName();
		assertEquals("OMCIT 596", actual5);
	...
	void testGetCourseID() {
		...
		// TODO write at least 2 additional test cases using different InfoProcessors
		int actual4 = infoProcessor4.getCourseId();
		assertEquals(593, actual4);

		int actual5 = infoProcessor5.getCourseId();
		assertEquals(596, actual5);
	}
	...
	void testGetStudentID() {
		...
		// TODO write at least 2 additional test cases using different InfoProcessors
		int actual4 = infoProcessor4.getStudentId();
		assertEquals(59876, actual4);

		int actual5 = infoProcessor5.getStudentId();
	...
	void testGetNextStringStartsWith() {
		...
		String actual4 = infoProcessor4.getNextStringStartsWith("CourseID:");
		assertEquals("593", actual4);
		
		String actual5 = infoProcessor5.getNextStringStartsWith("");
