...
public class InfoProcessor {
	...
	public String getCourseName() {
		...
		return this.getNextStringStartsWith("Course:");
	}
	...
	public int getCourseId() {
		...
		// TODO Implement method
		int courseIdString = Integer.parseInt(this.getNextStringStartsWith("CourseID:"));
	...
	public int getStudentId() {
		...
		return Integer.parseInt(this.getNextStringStartsWith("StudentID:"));
	}
	...
	String getNextStringStartsWith(String str) {
		...
		for (int i = 0; i < this.lines.size(); i++) {
			String word = this.lines.get(i);
			if (word.startsWith(str) && i+1 < this.lines.size()) {
